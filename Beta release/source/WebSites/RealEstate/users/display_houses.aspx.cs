...
public partial class users_display_houses : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "SELECT TOP 10 * FROM agency INNER JOIN listing ON listing.agency_id = agency.agency_id INNER JOIN agent ON listing.agent_id = agent.agent_id ORDER BY listing_hitCount DESC";
