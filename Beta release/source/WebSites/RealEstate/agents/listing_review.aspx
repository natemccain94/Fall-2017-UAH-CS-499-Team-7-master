...
<body style="height: 573px">
    <form id="form1" runat="server" class="auto-style1">
        <div class="auto-style2">
            ...
            <a href="schedule_listing.aspx">Go back to Schedule</a>
        ...
        <asp:Label ID="Label4" runat="server" Text="Agent Opinion of price"></asp:Label>
            ...
            <asp:Button ID="Button2" runat="server" OnClientClick="return false" OnClick="Button2_Click" Text="Update" Visible="False" />
