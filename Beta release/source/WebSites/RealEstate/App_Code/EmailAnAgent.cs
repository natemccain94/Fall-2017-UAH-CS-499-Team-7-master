...
using System.Net.Mail;
    ...
    public static class EmailAnAgent
    {
                                                    ...
                                                    string PurchaseAgreementToSend, string RepairsRequestToSend)
        {
            ...
            string ClosingSettlementPath = @"C:\agent_form\closingsettlement.txt";
            string PurchaseAgreementPath = @"C:\agent_form\purchaseagreement.txt";
            string RepairsRequestPath = @"C:\agent_form\repairsrequest.txt";
